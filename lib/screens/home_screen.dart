...
import 'package:freshnest_app/assets/assets.dart';
import 'package:freshnest_app/screens/cart_screen.dart';
import 'package:freshnest_app/screens/product_details_screen.dart';
...
class ProductCard extends StatefulWidget {
  const ProductCard({
    super.key,
    this.width = 140,
    this.height = 240, // Added height parameter
...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: widget.width,
      height: widget.height, // Apply height to prevent overflow
